    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-slate-200">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Quick guidance to help you choose halal products.</p>
        </div>
      </div>

      <div className="space-y-3">
        {tipsData.map(tip => (
          <div key={tip.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="flex gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-600 mt-1">{tip.text}</p>
              </div>
            </div>
          </div>
        ))}
